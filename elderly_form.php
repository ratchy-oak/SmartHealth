...
$page_title = 'แบบประเมินสุขภาพผู้สูงอายุ';
$header_title = '';
$years = [];
$hospitals = [];
$display_mode = ''; 
...
<body class="page-patient-form">
    ...
    <div class="container my-5">
        ...
        <?php elseif ($display_mode === 'year_select'): ?>
            <?php if (empty($years)): ?>
                <div class="alert alert-info text-center">ไม่พบข้อมูลปีโครงการที่มีผู้สูงอายุหรือผู้พิการสำหรับโรงพยาบาลนี้</div>
            <?php else: ?>
                <div class="row g-4 justify-content-center">
                    <?php foreach ($years as $year): ?>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                            <a href="elderly_list.php?year=<?= urlencode($year) ?>&hospital_id=<?= $selected_hospital_id ?? $user_hospital_id ?>" class="text-decoration-none">
                                <div class="year-card">
